...
<head>
  ...
  <title>Media - CreatorzHive</title>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(asset_url('frontend/css/media.css')) ?>">
</head>
<body>
<div class="app-shell">
...
<?php echo file_get_contents(__DIR__ . '/library.html'); ?>
    </main>
  </div>
</div>
...
<script src="<?= htmlspecialchars(asset_url('frontend/js/media.js')) ?>"></script>
<script src="<?= htmlspecialchars(asset_url('frontend/js/media-library.js')) ?>"></script>
</body>
</html>
