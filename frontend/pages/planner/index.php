...
<head>
  ...
  <title>Planner - CreatorzHive</title>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(asset_url('frontend/css/planner.css')) ?>">
</head>
<body>
<div class="app-shell">
...
<?php
echo file_get_contents(__DIR__ . '/planner.html');
?>
    </main>
  </div>
</div>
...
<script src="<?= htmlspecialchars(asset_url('frontend/js/planner.js')) ?>"></script>
</body>
</html>
